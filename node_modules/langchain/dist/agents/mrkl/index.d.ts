...
export declare class ZeroShotAgent extends Agent {
    ...
    llmPrefix(): string;
    static getDefaultOutputParser(): ZeroShotAgentOutputParser;
    ...
    static fromLLMAndTools(llm: BaseLanguageModel, tools: Tool[], args?: CreatePromptArgs & AgentArgs): ZeroShotAgent;
