...
const index_js_1 = require("../callbacks/index.cjs");
...
class BaseChain {
    constructor(memory, verbose, callbackManager) {
        ...
        this.callbackManager = callbackManager ?? (0, index_js_1.getCallbackManager)();
    }
    ...
    static async deserialize(data, values = {}) {
        switch (data._type) {
            ...
            case "simple_sequential_chain": {
                const { SimpleSequentialChain } = await import("./simple_sequential_chain.js");
